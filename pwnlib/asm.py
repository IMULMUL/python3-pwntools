...
------------------------
    ...
    in the :mod:`shellcraft` module.
        ...
        >>> asm(shellcraft.sh())
        b'jhh///sh/bin\x89\xe31\xc9j\x0bX\x99\xcd\x80'
...
def make_elf(data, vma=None, strip=True, **kwargs):
    ...
    Examples:
        ...
        >>> bin_sh = codecs.decode('6a68682f2f2f73682f62696e89e331c96a0b5899cd80', 'hex_codec')
...
def asm(shellcode, vma=0, **kwargs):
    ...
    Examples:
        ...
        .. doctest::
            ...
            b'\x04\x00\x1f\xe5R\x00\x90\x00'
    """
    result = b''
...
def disasm(data, vma=0, byte=True, offset=True, **kwargs):
    ...
    Examples:
        ...
        .. doctest::
          ...
          >>> print(disasm(codecs.decode('b85d000000', 'hex_codec'), arch='i386'))
             0:   b8 5d 00 00 00          mov    eax,0x5d
          >>> print(disasm(codecs.decode('b85d000000', 'hex_codec'), arch='i386', byte=0))
             0:   mov    eax,0x5d
          >>> print(disasm(codecs.decode('b85d000000', 'hex_codec'), arch='i386', byte=0, offset=0))
          mov    eax,0x5d
          >>> print(disasm(codecs.decode('b817000000', 'hex_codec'), arch='amd64'))
             0:   b8 17 00 00 00          mov    eax,0x17
          >>> print(disasm(codecs.decode('48c7c017000000', 'hex_codec'), arch='amd64'))
             0:   48 c7 c0 17 00 00 00    mov    rax,0x17
          >>> print(disasm(codecs.decode('04001fe552009000', 'hex_codec'), arch='arm'))
             0:   e51f0004        ldr     r0, [pc, #-4]   ; 0x4
             4:   00900052        addseq  r0, r0, r2, asr r0
          >>> print(disasm(codecs.decode('4ff00500', 'hex_codec'), arch='thumb', bits=32))
